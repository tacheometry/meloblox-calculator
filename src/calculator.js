...
const calculate = ({
    ...
    monstersSlain.normal =
        grindTime / ((monsters["normal"].killTime + monsters["normal"].cooldown) / 60)
    monstersSlain.bosses =
        grindTime / ((monsters["boss"].killTime + monsters["boss"].cooldown) / 60)
    monstersSlain.total =
    ...
    chanceData["Rare"].chance =
        (totalMF / 10 / 100) * chanceData["Uncommon"].chance;
    chanceData["Epic"].chance =
        (totalMF / 18 / 100) * chanceData["Rare"].chance;
    chanceData["Legendary"].chance =
        (totalMF / 38 / 100) * chanceData["Epic"].chance;
    ...
    chanceData["Common"].count =
        chanceData["Common"].chance * monstersSlain.total;
    ...
    chanceData["Rare"].count =
        chanceData["Rare"].chance * monstersSlain.total;

    chanceData["Epic"].tries = 1 / chanceData["Epic"].chance;
    chanceData["Epic"].count =
        chanceData["Epic"].chance * monstersSlain.total;
